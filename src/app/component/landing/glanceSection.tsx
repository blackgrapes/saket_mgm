...
const stats = [
  { icon: <Library size={40} className="text-[#f82f53]" />, value: 35, label: 'Years of Legacy', suffix: '+' },
  { icon: <Users size={40} className="text-[#f82f53]" />, value: 2500, label: 'Students Enrolled', suffix: '+' },
  { icon: <Medal size={40} className="text-[#f82f53]" />, value: 150, label: 'Qualified Faculty', suffix: '+' },
  { icon: <GraduationCap size={40} className="text-[#f82f53]" />, value: 20, label: 'Diverse Programs', suffix: '+' },
];
